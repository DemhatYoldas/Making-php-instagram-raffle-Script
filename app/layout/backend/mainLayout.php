                ...
                <ul class="nav navbar-nav">
                    ...
                    <li class="dropdown user user-menu">
                        ...
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                            ...
                            <img src="/images/admins/<?php echo $_SESSION['admins']['admins_file']; _?>" class="user-image" alt="User Image">
                            <!-- hidden-xs hides the username on small devices so only the image appears. -->
                            <span class="hidden-xs"><?php echo $_SESSION['admins']['admins_namesurname']; _?></span>
                        </a>
                        <ul class="dropdown-menu">
                            <!-- The user image in the menu -->
                            <li class="user-header">
                                <img src="/images/admins/<?php echo $_SESSION['admins']['admins_file']; _?>" class="img-circle" alt="User Image">
        ...
        <section class="sidebar">
            ...
            <div class="user-panel">
                ...
                <div class="pull-left info">
                    <p><?php echo $_SESSION['admins']['admins_namesurname']; _?></p>
                    <!-- Status -->
            ...
            <ul class="sidebar-menu" data-widget="tree">
                ...
                <li><a href="/nedmin/abouts"><i class="fa fa-file"></i> <span>Sayfalar</span></a></li>
                <li><a href="/nedmin/sliders"><i class="fa fa-file-image-o"></i> <span>Sliders</span></a></li>
                <li><a href="/nedmin/blogs"><i class="fa fa-file"></i> <span>Blogs</span></a></li>

                <li class="active treeview">
                    <a href="#"><i  class="fa fa-cog "></i> <span>Yönetim</span>
